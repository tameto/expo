...
import { NativeViewGestureHandler, PanGestureHandler, TapGestureHandler, State as GestureState, } from 'react-native-gesture-handler';
...
let BottomSheetBehavior = /** @class */ (() => {
    class BottomSheetBehavior extends React.Component {
        constructor(props) {
            ...
            this.Y = add(100, this.withEnhancedLimits(withDecaying(withPreservingAdditiveOffset(this.dragY, this.panState), this.panState, this.decayClock, this.velocity, this.preventDecaying), masterOffseted));
        ...
        render() {
            ...
            return (React.createElement(React.Fragment, null,
                ...
                React.createElement(Animated.View, { style: {
                    ...
                    React.createElement(PanGestureHandler, { enabled: this.props.enabledGestureInteraction && this.props.enabledHeaderGestureInteraction, ref: this.master, waitFor: this.panRef, onGestureEvent: this.handleMasterPan, onHandlerStateChange: this.handleMasterPan },
                        React.createElement(Animated.View, { style: {
                                zIndex: 101,
                    ...
                    React.createElement(View, { style: this.props.enabledInnerScrolling && {
                        ...
                        React.createElement(PanGestureHandler, { enabled: this.props.enabledGestureInteraction && this.props.enabledContentGestureInteraction, waitFor: this.master, ref: this.panRef, onGestureEvent: this.handlePan, onHandlerStateChange: this.handlePan, simultaneousHandlers: [this.scrollViewRef] },
                            React.createElement(Animated.View, { style: { flex: 1 } },
                                React.createElement(TapGestureHandler, { ref: this.tapRef, enabled: this.props.enabledGestureInteraction &&
                                        ...
                                        this.props.enabledContentTapInteraction, onHandlerStateChange: this.handleTap },
                                    React.createElement(Animated.View, { style: {
                                            width: '100%',
                                            flex: 1,
                                            transform: [{ translateY: this.Y }],
                                        }, onLayout: this.handleLayoutContent },
                                        React.createElement(NativeViewGestureHandler, { ref: this.scrollViewRef, simultaneousHandlers: this.panRef },
                                            React.createElement(Animated.ScrollView, { overScrollMode: "never", bounces: false, onScrollBeginDrag: this.onScrollBeginDrag, scrollEventThrottle: 1, contentContainerStyle: { backgroundColor: 'red' } },
                                                React.createElement(View, { style: { height: 2000, backgroundColor: 'blue' } },
                                                    React.createElement(Text, null, "Dupa1"),
                                                    React.createElement(Text, null, "Dupa2"),
                                                    React.createElement(Text, null, "Dupa3"),
                                                    React.createElement(Text, null, "Dupa4")))))))),
